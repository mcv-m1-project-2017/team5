...
[pPrecisionw4,pAccuracyw4,pSensitivityw4,pF1w4,pRecallw4,windowTP4,windowFN4,windowFP4 ] = ReadAndApplyTemplates(directory,pDirectory,templatesDirectory,false ,true,1);
...
[pPrecisionw6,pAccuracyw6,pSensitivityw6,pF1w6,pRecallw6,windowTP6,windowFN6,windowFP6 ] = ReadAndApplyTemplates(directory,pDirectory,templatesDirectory,false ,true,2);
%12_3
directory = '../DataSet/train/validation_split/YcbCrAndHSV_mask/12_3/';
...
[pPrecisionw8,pAccuracyw8,pSensitivityw8,pF1w8,pRecallw8,windowTP8,windowFN8,windowFP8 ] = ReadAndApplyTemplates(directory,pDirectory,templatesDirectory,false ,true,2);
