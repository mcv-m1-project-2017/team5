...
[pPrecisionw2,pAccuracyw2,pSensitivityw2,pF1w2,pRecallw2,windowTP2,windowFN2,windowFP2 ] = ReadAndApplyTemplates(directory,pDirectory,false,1);
...
[pPrecisionw4,pAccuracyw4,pSensitivityw4,pF1w4,pRecallw4,windowTP4,windowFN4,windowFP4 ] = ReadAndApplyTemplates(directory,pDirectory,false,1);
...
[pPrecisionw6,pAccuracyw6,pSensitivityw6,pF1w6,pRecallw6,windowTP6,windowFN6,windowFP6 ] = ReadAndApplyTemplates(directory,pDirectory,false,2);
%12_3
directory = '../DataSet/train/validation_split/YcbCrAndHSV_mask/12_3/';
...
[pPrecisionw8,pAccuracyw8,pSensitivityw8,pF1w8,pRecallw8,windowTP8,windowFN8,windowFP8 ] = ReadAndApplyTemplates(directory,pDirectory,false,2);
